...
- `M4 Browser Fetchers`：Playwright Java + Chromium sync/async 基线、browser request option 语义测试、stealth launch parity、真实 page reuse、pageAction、Cloudflare 检测与基础求解 flow 已落地；`timeout/load_dom/wait`、`proxy/retries`、`init_script/user_data_dir/cdp_url` 等仍待补齐
